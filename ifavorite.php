...
<div class="grid_3">
    <div class="container">
        <div class="breadcrumb1">
            ...
            <li class="current-page">I <span class="glyphicon glyphicon-heart" style = "color: #b43346" aria-hidden="true"></span> whom & not matches</li>
            </ul>
        </div>
        ...
        <div class="col-md-9">
            <?php
            $check = 0;
            $ilikeresult = mysqli_query($con,"SELECT * FROM relation WHERE user1 = '$myusername'");
            while($ilike=mysqli_fetch_array($ilikeresult)) {
                $ilikeuser = $ilike['user2'];
                $matchresult = mysqli_query($con,"SELECT * FROM relation WHERE user1 = '$ilikeuser' AND user2 = '$myusername'");
                $match=mysqli_fetch_array($matchresult);
                if (!$match) {
                    $notmatchuser = $ilikeuser;
                    ...
                    if ($row) {
                        ...
                        <div class="col-sm-9"><a
                                    href="view_profile.php?user=<?php echo $row['username']; ?>&delete=0&like=0"></a>
            ...
            if ($check==0) {
                echo "All people I like match with me!";
            }
            ?>
        </div>
