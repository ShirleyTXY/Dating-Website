    ...
    <div class="container">
        <div class="breadcrumb1">
            ...
            <li class="current-page"><a href="matches.php">New Matches</a></li>
                <li>
                    <form class="form-search " action = "matches.php">
                        <div class="input-append">
                            <input type="text" class="span2 search-query" name="searchinput" required="required">
        ...
        <div class="col-sm-9">
            ...
            if ($row) {
            if (!(isset($_REQUEST["search"])&& isset($_REQUEST["searchinput"]))) {?>
        ...
        <?php
            ...
            $filter = $_REQUEST["searchinput"];
            if ($row['username']==$filter) {
                ?>
