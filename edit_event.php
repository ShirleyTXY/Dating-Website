...
if (isset($_POST['submit'])) {
    ...
    if (!isset($error_message)) {
        ...
        if (empty($error_message)) {
            ...
            if (empty($checkdup1)) {
                ...
                $q = "UPDATE event SET privacygroup = '$privacy',submitdate='$submitdate',location='$location',privacy ='$intoprivacy', eventdate='$eventdate', eventtime='$eventtime', description='$description'WHERE username = '$username' AND eventname = '$eventname'";
                $r = mysqli_query($con, $q); // Run the query.
                if ($r) {
                    $success_message = "Congratulation! You have changed successfully!";
                    $error_message = "";
                } else {
                    $error_message = "Please try again.";
                }
            } else {
                $error_message = "You have already added this event!.";
            }
        }
    ...
    $con = mysqli_connect('localhost', 'root', '', 'datingwebsite') OR die ('Could not connect to MySQL: ' . mysqli_connect_error());
    mysqli_set_charset($con, 'utf8');
    $q = "DELETE FROM event WHERE username = '$username' AND eventname = '$eventname'";
    $r = mysqli_query ($con, $q); // Run the query.
    $q = "DELETE FROM tag WHERE username = '$username' AND eventname = '$eventname'";
    $r = mysqli_query ($con, $q); // Run the query.
    $q = "DELETE FROM like_event WHERE username = '$username' AND eventname = '$eventname'";
    $r = mysqli_query ($con, $q); // Run the query.
    if($r) {
        $success_message = "You have deleted the event.";
        $error_message ="";
    } else {
        $error_message = "Please try again.";
    }
...
$result = mysqli_query($con,"SELECT * FROM event WHERE username='$username' AND eventname='$eventname' 
            ");
            ...
            <div class="breadcrumb1">
                <ul>
                    <div class="col-md-9">
                        ...
                        <li class="current-page">Edit Events</li>
                    </div>
                    <div class="col-md-3">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        ...
                        <input type="text" class="form-text" name="eventname" value="<?php echo $row['eventname'] ?> " readonly>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        ...
                        <input type="text" name="location" class="form-text" value="<?php echo $row['location'] ?>">
                    </div>
                </div>
                <div class="clearfix"> </div>
            </div>
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-2 col-md-offset-3">
                        <input type="text" name="date" class="form-text" value="<?php echo $row['eventdate'] ?>">
                    </div>
                    <div class="col-md-2">
                        <input type="text" name="time" class="form-text" value="<?php echo $row['eventtime'] ?>">
                    </div>
                </div>
                <div class="clearfix"> </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-offset-3">
                            <?php if($all_tags->num_rows > 0) { ?>
                                <?php while($row1=mysqli_fetch_array($all_tags)) {?>
                                    <div class="col-md-1">
                                        <input class="btn btn-link" type="button" value="<?php echo $row1['tag']?>">
                                    </div>
                                <?php }?>
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        ...
                        <div class="age_box1" style="max-width: 100%; display: inline-block;">
                            ...
                            <select name = "privacy" required="required">
                                <?php
                                if ($row['privacygroup']=="Everyone") { ?>
                                    <option value="Everyone" active>Everyone</option>
                                    <option value="All matches friends">All matched friends</option>
                                ...
                                <?php }
                                }  elseif ($row['privacygroup']=="All matches friends") { ?>
                                    <option value="All matches friends" active>All matched friends</option>
                                ...
                                <option value="<?php  echo $row['privacygroup']?>" active >Matched friends in group "<?php  echo $row['privacygroup']?>"</option>
                                <option value="All matches friends">All matched friends</option>
                                <option value="Everyone" >Everyone</option>
                                <?php while($group = mysqli_fetch_array($groupsql)  ) {
                                    if ($group['usergroup']!= $row['privacygroup']) { ?>
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        ...
                        <div class="textarea-container">
                            <textarea type="text" class="form-text" name="description" placeholder="<?php echo $row['description'] ?>"></textarea>
